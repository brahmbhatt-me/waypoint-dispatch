          ...
          <div className="space-y-4">
            {existingUser && (
              <div className="card bg-blue-50 border-blue-100">
                <p className="text-sm text-blue-700">👋 Welcome back, <strong>{existingUser.name}</strong>!</p>
              </div>
            )}
            ...
            <div className="card space-y-4">
              ...
              <div>
                ...
                <p className="text-xs text-gray-400 mb-2">Not counting yourself</p>
              ...
              <div>
                <label className="label">
                  Your starting location <span className="text-gray-400 font-normal">(optional)</span>
                </label>
                <AddressAutocomplete
                  value={startAddress}
                ...
                <p className="text-xs text-gray-400 mt-1">
                  Used to route you to pick up passengers before Ruggles
                </p>
              </div>

              <div>
                <label className="label">Notes <span className="text-gray-400 font-normal">(optional)</span></label>
                <input type="text" placeholder="e.g., can only take north side passengers" value={notes} onChange={(e) => setNotes(e.target.value)} className="input" />
              </div>
            </div>
        ...
        {step === "success" && (
          <div className="space-y-4">
            <div className="card text-center py-8">
              ...
              <p className="text-gray-500 text-sm">You&rsquo;ll receive your passenger list and optimized route before the trip.</p>
            </div>
