  ...
  return (
    <div className="page-container">
          ...
          {!loading && trip && (
            <div className="mt-5 bg-white/20 backdrop-blur rounded-xl p-4">
              <div className="flex items-center justify-between">
                ...
                <span
                  className={`text-xs font-medium px-2.5 py-1 rounded-full ${statusColor[trip.status] ?? "bg-white/20 text-white"}`}
                >
              ...
              <div className="flex gap-4 mt-3 text-sm">
                <div>
                  ...
                  <span className="text-orange-100 ml-1">passengers</span>
                </div>
                <div>
                  <span className="font-semibold">{trip.driverCount}</span>
                  <span className="text-orange-100 ml-1">drivers</span>
                </div>
                <div>
                  <span className="font-semibold">{trip.totalSeats}</span>
                  <span className="text-orange-100 ml-1">seats</span>
                </div>
              </div>
            </div>
          )}
      ...
      <div className="max-w-lg mx-auto px-4 py-6 space-y-3">
          ...
          <div className="card flex items-center gap-4 cursor-pointer hover:shadow-md active:bg-gray-50 transition-all">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-sm text-gray-500 mt-0.5">
                Register your name &amp; dropoff address for this Saturday
              </p>
            </div>
        ...
        <Link href="/driver/register">
          <div className="card flex items-center gap-4 cursor-pointer hover:shadow-md active:bg-gray-50 transition-all">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-sm text-gray-500 mt-0.5">
                Register your car &amp; available seats for this Saturday
              </p>
            </div>
            <svg className="w-5 h-5 text-gray-400 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
        ...
        {/* View assignments — only show if locked */}
        {trip?.status === "LOCKED" && (
          <Link href={`/view/${trip.id}`}>
            <div className="card flex items-center gap-4 cursor-pointer hover:shadow-md transition-all border-2 border-orange-200">
              ...
              <div className="flex-1 min-w-0">
                <p className="font-semibold text-orange-600">View My Assignment</p>
                <p className="text-sm text-gray-500 mt-0.5">
                  See your assigned car &amp; route for today
                </p>
              </div>
        ...
        <div className="relative py-2">
          ...
          <div className="relative flex justify-center">
            <span className="bg-gray-50 px-3 text-xs text-gray-400 uppercase tracking-wider">
              Organizers
            </span>
          </div>
        </div>
        ...
        <Link href="/admin">
          <div className="card flex items-center gap-4 cursor-pointer hover:shadow-md active:bg-gray-50 transition-all">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-sm text-gray-500 mt-0.5">
                Manage passengers, generate assignments, share routes
              </p>
            </div>
            <svg className="w-5 h-5 text-gray-400 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
        ...
        <p className="text-center text-xs text-gray-400 pt-4">
          BAPS Boston Campus Connect · Made with 🙏
        </p>
      </div>
    </div>
  );
